      ...
      <main>
        ...
        {isVisible &&(
           <div className={`menu ${isVisible ? 'active' : ''}`}>
            <nav>
              <Link onClick={resetSearch} to ="/"><span className='home'><BiHomeAlt/></span> Home</Link>
        ...
        <form className="todo" onSubmit={AddTodo}>
          ...
          <select value={selectType} onChange={(e) => setTodoType(e.target.value)}>
